# async def parse(season_start: int, season_end: int, year: int) -> None:  # async
# def parse(args) -> None:  # multiprocessing
#     season_start, season_end, year = args  # multiprocessing
